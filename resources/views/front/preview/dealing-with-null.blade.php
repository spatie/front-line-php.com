...
$paymentDate ? $paymentDate-&gt;<span class="hljs-highlight  prop">format</span>(<span class="hljs-string">'Y-m-d'</span>) : <span class="hljs-keyword">null</span>;</code></pre>
    ...
    <h2 id="dealing-with-null-—-there's-another-way"><a href="#dealing-with-null-—-there's-another-way" class="heading-anchor">#</a> Dealing with null — there's another way</h2>
