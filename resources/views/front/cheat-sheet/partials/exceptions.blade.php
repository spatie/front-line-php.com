<x-card id="exceptions" title="Exceptions">
    <p>Throwing an exception is an expression now, which means there are more places you can throw from, such a short closures or as a null coalescing fallback:</p>
