...
We shall make sure that the latest version of these Terms of Use shall always be available on <https://front-line-php.com/terms-of-use>.
...
2. “Video Course”: the Laraval Package Training video's as an educational product listed and described on <https://front-line-php.com>, including all course material through videos;
...
2.1. By accepting these Terms of Use, Spatie grants You access to the complete video course after the payment of the Fee. You can always read the content of the video course and all of its features at: <https://front-line-php.com>.
...
3.2. The entire Video Course shall be available for download after the payment of the Fee. You have to fill in a purchase form at <https://front-line-php.com> with your personal- and payment information. Spatie reserves the right to cancel the purchase if the purchase form is incomplete or incorrect.
...
7.1. All payments concerning the purchase of the Video Course shall be handled by [Paddle](https://paddle.com/) in accordance with its terms and conditions. Paddle handles all payments through <https://front-line-php.com> by using Paddle’s SDK. Spatie does not store any of your payment details.
