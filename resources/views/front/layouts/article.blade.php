...
@section('content')
    ...
    <header>
        <div class="h-32">
            ...
            <div class="mx-auto max-w-3xl px-4 sm:px-16 h-32 flex items-center">
        ...
        <div class="mx-auto max-w-3xl px-4 sm:px-16 py-16">
    ...
    <main class="mx-auto max-w-3xl px-4 sm:px-16" style="background-image: linear-gradient(to bottom, #daf1f5, #fff 200vh )">
