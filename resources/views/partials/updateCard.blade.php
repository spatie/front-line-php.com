        ...
        <div class="z-10 flex-grow shadow-2xl">
            <div class="bg-yellow-500">
                <div class="text-center pt-4 pb-8 leading-none">
                    <div class=" mt-4">
                        <h1 class="font-bold text-4xl sm:text-5xl whitespace-no-wrap">PHP 8.3 Update</h1>
                    </div>
                </div>
                ...
                <div class=" py-8 px-12 flex flex-wrap  bg-white">
                    <div>
                        <ul class=" leading-relaxed">
                            <li><i class="fas fa-check text-xs text-blue-500"></i> A brand new chapter <span class="font-semibold">on PHP 8.3</span></li>
                ...
                <div class="pb-10 px-12 w-full flex flex-wrap bg-gray-100">
