...
@section('cta_body')
    ...
    <div class="block text-xl font-semibold leading-relaxed text-white text-opacity-90">
        You've just read part of our upcoming book called <a href="https://front-line-php.com">Front Line PHP</a>, it'll arrive by the end of this year and be the best way to learn modern day PHP and PHP 8.3.
        <br><br>
